...
func TestProductionImportsStayWithinArchitectureBoundaries(t *testing.T) {
	...
	rules := []importRule{
		...
		{
			name:          "adapters depend on ports, not concrete application handlers",
			packagePrefix: modulePath + "/internal/adapters/",
			forbiddenImports: []string{
				modulePath + "/cmd/",
				modulePath + "/internal/application/command",
				modulePath + "/internal/application/query",
		...
		{
			name:          "inbound adapters use inbound application contracts only",
			packagePrefix: modulePath + "/internal/adapters/inbound/",
			forbiddenImports: []string{
				modulePath + "/internal/adapters/outbound",
				modulePath + "/internal/application/port/outbound",
				modulePath + "/internal/application/command",
		...
		{
			name:          "outbound adapters do not depend on inbound delivery",
			packagePrefix: modulePath + "/internal/adapters/outbound/",
			forbiddenImports: []string{
...
func TestUnitTestImportsStayWithinPackageBoundaries(t *testing.T) {
	...
	rules := []importRule{
		...
		{
			name:          "application command unit tests do not use concrete adapters or other use cases",
			packagePrefix: modulePath + "/internal/application/command",
			forbiddenImports: []string{
				modulePath + "/cmd/",
				modulePath + "/internal/adapters/",
		...
		{
			name:          "application query unit tests do not use concrete adapters or other use cases",
			packagePrefix: modulePath + "/internal/application/query",
			forbiddenImports: []string{
				modulePath + "/cmd/",
				modulePath + "/internal/adapters/",
		...
		{
			name:          "application workflow unit tests do not use concrete adapters or command/query handlers",
			packagePrefix: modulePath + "/internal/application/workflow",
			forbiddenImports: []string{
				modulePath + "/cmd/",
				modulePath + "/internal/adapters/",
		...
		{
			name:          "inbound adapter unit tests use inbound application contracts only",
			packagePrefix: modulePath + "/internal/adapters/inbound/",
			forbiddenImports: []string{
				modulePath + "/internal/adapters/outbound",
				modulePath + "/internal/application/port/outbound",
		...
		{
			name:          "outbound adapter unit tests do not depend on inbound delivery or use cases",
			packagePrefix: modulePath + "/internal/adapters/outbound/",
			forbiddenImports: []string{
				modulePath + "/internal/adapters/inbound",
				modulePath + "/internal/application/port/inbound",
