...
func TestRunWorkerBuildsDockerSandboxProvider(t *testing.T) {
	t.Setenv("AGENTPOOL_MODEL_PROVIDER", "noop")
...
func TestRunWorkerReturnsErrorForInvalidSandboxProvider(t *testing.T) {
	t.Setenv("AGENTPOOL_MODEL_PROVIDER", "noop")
	t.Setenv("AGENTPOOL_SANDBOX_PROVIDER", "bad")
...
func TestWorkerInstanceWiresToolRegistry(t *testing.T) {
	t.Setenv("AGENTPOOL_MODEL_PROVIDER", "noop")
